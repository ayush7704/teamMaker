        ...
        <nav className='flex bg-[#141414] fixed left-1/2 -translate-x-1/2 rounded-[4rem] overflow-hidden items-center bottom-2 mx-auto z-[25] w-max'>
            {
                [
                    {
                        name: 'home',to: 'home', svg: (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-[1.19rem] h-[1.19rem]' color="inherit" fill="none">
                        ...
                        name: 'how-to',to: 'how-to', svg: (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-[1.19rem] h-[1.19rem]' color="inherit" fill="none">
            ...
            </div>
            {
                [
                    {
                        name: 'saved',to: 'saved', svg: (<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-[1.19rem] h-[1.19rem]' color="inherit" fill="none">
