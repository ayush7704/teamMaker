        ...
        <nav className='flex bg-[#141414] fixed left-1/2 -translate-x-1/2 rounded-[4rem] overflow-hidden items-center  bottom-2 mx-auto z-[25] w-max'>
            {
                [
                    {
                        name: 'home',to: 'home', svg: (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-[1.19rem] drop-shadow-[0px_0px_12px_currentColor] h-[1.19rem]' color="inherit" fill="none">
                        ...
                        name: 'how-to',to: 'how-to', svg: (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-[1.19rem] drop-shadow-[0px_0px_12px_currentColor] h-[1.19rem]' color="inherit" fill="none">
                        ...
                        <NavLink key={elm.name + ind} to={elm.to === 'home' ? '/' : elm.to} className={`${elm.name === 'home' && location.pathname === '/' ? 'text-[--theme]' : ''} ${elm.to === (location.pathname).replace(/%20/g, ' ').slice(1) ? 'text-[--theme]' : ''} hover:text-[--theme] pageLinks text-[0.65rem] font-thin sm:text-[0.70rem] sm:font-light lg:text-[0.80rem] lg:font-normal transition-all duration-[200ms] capitalize px-4 text-nowrap py-2`}>
                            <p className='text-center grid justify-center'>
                                <span>
                                    {elm.svg}
                                </span>
                            </p>
                            <p className='capitalize text-nowrap sm:tracking-[0.6px]'>{elm.name}</p>
                        </NavLink>
                    ))
            }
            {/* translate-y-[-30%] */}
            ...
            </div>
            {
                [
                    {
                        name: 'saved',to: 'saved', svg: (<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-[1.19rem] drop-shadow-[0px_0px_12px_currentColor] h-[1.19rem]' color="inherit" fill="none">
