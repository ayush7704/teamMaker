        ...
        <nav className='flex bg-[#141414] fixed left-1/2 -translate-x-1/2 rounded-[4rem] overflow-hidden items-center  bottom-2 mx-auto z-[25] w-max'>
            {
                [
                    {
                        name: 'home',to: 'home', svg: (<svg viewBox="0 0 24 24" className='w-[1.19rem] drop-shadow-[0px_0px_12px_currentColor] h-[1.19rem]' color="inherit" fill="none">
                        ...
                        name: 'how-to',to: 'how-to', svg: (<svg viewBox="0 0 24 24" className='w-[1.19rem] drop-shadow-[0px_0px_12px_currentColor] h-[1.19rem]' color="inherit" fill="none">
                        ...
                        <NavLink key={elm.name + ind} to={elm.to === 'home' ? '/' : elm.to} className={`${elm.name === 'home' && location.pathname === '/' ? 'text-[#ffa600]' : ''} ${elm.to === (location.pathname).replace(/%20/g, ' ').slice(1) ? 'text-[#ffa600]' : ''} hover:text-[#ffa600] pageLinks text-[0.65rem] font-thin sm:text-[0.70rem] sm:font-light lg:text-[0.80rem] lg:font-normal transition-all duration-[200ms] capitalize px-4 text-nowrap py-2`}>
            ...
            </div>
            {
                [
                    {
                        name: 'saved',to: 'saved', svg: (<span><svg viewBox="0 0 24 24" className='w-[1.19rem] drop-shadow-[0px_0px_12px_currentColor] h-[1.19rem]' color="inherit" fill="none">
