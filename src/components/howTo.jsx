  ...
  return (
    <>
      ...
      <div className='sm:w-[80%] mx-auto p-3'>
        ...
        <div className='mb-4 sm:p-8 p-5 backdrop-blur-[8px] rounded-2xl outline outline-1 outline-[#2a2a2a] overflow-hidden fade-up'>
          <h2 className='text-[1.05rem] leading-[100%] capitalize'>3. save your work locally in the browser.</h2>
          <div className='grid gap-8 p-3'>
            ...
            <HowToExamples title={`2. Click here in the navbar to see saved work.`} element={<div className='inline-block bg-[#141414] rounded-[0.75rem] text-[0.70rem] sm:text-[0.75rem] lg:text-[0.85rem] font-normal capitalize text-nowrap py-2 px-2 '>
              <p className='flex justify-center'>
                <svg viewBox="0 0 24 24" className='w-[1.19rem] h-[1.19rem]' color="inherit" fill="none">
