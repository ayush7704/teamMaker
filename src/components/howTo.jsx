      ...
      <div className='sm:w-[80%] mx-auto p-3 sm:text-[1rem] text-[0.95rem]'>
        ...
        <div className='mb-4 sm:p-8 p-5 backdrop-blur-[8px] rounded-2xl outline outline-1 outline-[#2a2a2a] overflow-hidden fade-up'>
          ...
          <div className='grid gap-8 p-3'>
            ...
            <HowToExamples title={`2. Click here in the navbar to see saved Projects.`} element={<div className='inline-block bg-[#141414] rounded-[0.75rem] text-[0.70rem] sm:text-[0.75rem] lg:text-[0.85rem] font-normal capitalize text-nowrap py-2 px-2 '>
